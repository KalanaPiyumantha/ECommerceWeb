    ...
    <div class="container-scroller">
        <div class="p-0 m-0 row proBanner" id="proBanner">
            <div class="p-0 m-0 col-md-12">
                <div class="px-3 card-body card-body-padding d-flex align-items-center justify-content-between">
                    <div class="ps-lg-3">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <a href="https://www.bootstrapdash.com/product/corona-admin-template/" target="_blank"
                                class="border-0 btn me-2 buy-now-btn">Buy Now</a>
                        </div>
                    </div>
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <button id="bannerClose" class="p-0 border-0 btn">
                            <i class="text-white mdi mdi-close"></i>
                        </button>
                    </div>
                </div>
            </div>
                ...
                <li class="nav-item menu-items">
                    ...
                    <div class="collapse" id="auth">
                        <ul class="nav flex-column sub-menu">
                            ...
                            <li class="nav-item"> <a class="nav-link" href="pages/samples/error-500.html"> 505
                                </a>
                            </li>
            ...
            <div class="main-panel">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div
                                        ...
                                        <div
                                            class="flex-grow align-self-center text-end text-md-center text-xl-right py-md-2 py-xl-0">
                                                ...
                                                <div class="preview-item border-bottom">
                                                    ...
                                                    <div class="flex-grow preview-item-content d-sm-flex">
                                                        <div class="flex-grow">
                                                            ...
                                                            <p class="mb-0 text-muted">Sent release details to team
                                                            </p>
                                                        </div>
                                                        <div class="pt-2 mr-auto text-sm-right pt-sm-0">
                ...
                <footer class="footer">
                    <div class="d-sm-flex justify-content-center justify-content-sm-between">
                        <span class="text-center text-muted text-sm-left d-block d-sm-inline-block">Copyright ©
                            2024 <a href="https://www.bootstrapdash.com/" target="_blank">BootstrapDash</a>. All
                            rights
                            reserved.</span>
                        <span class="float-none mt-1 text-center text-muted float-sm-end d-block mt-sm-0"> <span
                                class="float-none mt-1 text-center text-muted float-sm-end d-block mt-sm-0">Hand-crafted
